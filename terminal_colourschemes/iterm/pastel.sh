...
# Adds decent colour scheme to iterm.
# Source: <url:http://kpumuk.info/mac-os-x/customizing-iterm-creating-a-display-profile-with-pastel-colors/>

# Note: this script must be:

# 1) Run from within terminal.app, and
# 2) Be run when iterm is closed, or the settings will not be applied:
